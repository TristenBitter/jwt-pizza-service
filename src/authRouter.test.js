...
beforeAll(() => {
  jest.spyOn(DB, 'getFranchises').mockResolvedValue([[{ id: 1, name: 'Fr1' }], false]);
  jest.spyOn(DB, 'getUserFranchises').mockResolvedValue([{ id: 1, name: 'Fr1' }]);
  jest.spyOn(DB, 'createFranchise').mockResolvedValue({ id: 1, name: 'Fr1' });
  jest.spyOn(DB, 'deleteFranchise').mockResolvedValue();
  jest.spyOn(DB, 'getFranchise').mockResolvedValue({ id: 1, admins: [], stores: [] });
